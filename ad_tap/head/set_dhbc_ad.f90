...
!  tapenade 3.x
!
!  Differentiation of set_dhbc in reverse (adjoint) mode (with options noISIZE i8):
!   gradient     of useful results: *head *dbc_data *bcperiod *propunit
