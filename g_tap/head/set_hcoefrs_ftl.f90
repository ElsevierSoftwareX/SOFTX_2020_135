...
!  tapenade 3.x
!
!  Differentiation of set_hcoefrs in forward (tangent) mode:
...
SUBROUTINE g_SET_HCOEFRS(ismpl)
  USE ARRAYS
...
&     HSTOR, VISF
  EXTERNAL g_BUOY, g_HSTOR
! INTEGER c1, c2, c3, c4
  DOUBLE PRECISION :: BUOY, COMPF, COMPM, RHOF, POR, &
& DELTAT, HSTOR, VISF
  DOUBLE PRECISION :: g_BUOY, g_HSTOR
  EXTERNAL DUMMY
...
! - - - - - - - -  transient - - - - - - - - - - -
    CALL g_OMP_MVP(i0, j0, k0, headold(1, cgen_time, ismpl), &
&              g_headold(1, cgen_time, ismpl), x(1, 1, 1, ismpl), &
