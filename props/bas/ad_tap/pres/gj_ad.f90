...
!  tapenade 3.x
!
!  Differentiation of gj in reverse (adjoint) mode (with options noISIZE i8):
!   gradient     of useful results: *temp *propunit *pres gj
...
SUBROUTINE GJ_AD0(i, j, k, ismpl, gj_ad)
  use arrays
