...
!   gradient     of useful results: *d *e *f *g *w *headold *x
!                *propunit *a *b *c
!   with respect to varying inputs: *d *e *f *g *w *headold *x
!                *propunit *a *b *c
!   Plus diff mem management of: d:in e:in f:in g:in w:in headold:in
!                x:in propunit:in simtime:in a:in b:in c:in
