...
!  tapenade 3.x
!
!  Differentiation of fi in forward (tangent) mode:
!   variations   of useful results: fi
...
DOUBLE PRECISION FUNCTION g_FI(i, j, k, ismpl, fi)
  USE ARRAYS
  ...
  IF (i0 .GT. 1 .AND. i .LT. i0) THEN
    ...
    IF (summ .GT. 0.d0) THEN
      g_fi = 2.d0*(g_prod-prod*g_summ/summ)/summ
      fi = 2.d0*prod/summ
    ELSE
      g_fi = 0.D0
    END IF
