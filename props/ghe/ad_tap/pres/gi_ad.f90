...
!  tapenade 3.x
!
!  Differentiation of gi in reverse (adjoint) mode (with options noISIZE i8):
!   gradient     of useful results: *temp *propunit *pres gi
...
SUBROUTINE GI_AD0(i, j, k, ismpl, gi_ad)
  use arrays
