...
c-----------------------------------------------------------------------
      ...
      implicit none
      include 'visim.inc'
      double precision TINY, c,d,e,f,g,h, xx,yy,zz
      parameter(TINY=1.0d-10)
      integer :: i,ic,ix,iy,iz,il,kc,j,jc,k,loc
...
c
      call cova3(0.0d0,0.0d0,0.0d0,0.0d0,0.0d0,0.0d0,1,nst,MAXNST,c0,it,
     +           cc,aa,1,MAXROT,rotmat,cmax,cbb)
c
      ...
      do i=-nctx,nctx
         ...
         do j=-ncty,ncty
            ...
            do k=-nctz,nctz
               zz = k * zsiz
      kc = nctz + 1 + k
      call cova3(0.0d0,0.0d0,0.0d0,xx,yy,zz,1,nst,MAXNST,c0,it,cc,aa,
     +     1,MAXROT,rotmat,cmax,covtab(ic,jc,kc))
      hsqd = sqdist(0.0d0,0.0d0,0.0d0,xx,yy,zz,isrot,
     +     MAXROT,rotmat)
