...
c-----------------------------------------------------------------------
      ...
      integer :: volindex
      integer :: sim_index
      integer :: vol, ix,iy,iz
      integer :: nsensvol,sensvol(MAXVOLS),volok(MAXVOLS)
caw
      integer :: temp(MAXVOLS)
caw-end
      double precision covvol(MAXVOLS),xx,yy,zz
      integer :: idata,nvolok
      integer :: nclosevol
      double precision covsum, c,d,e,f,g,h, cov
      integer :: ivol1,ivol2,inhood,i,j, dinnhood
      integer :: nusevols_temp, isensvol, ivol
      integer :: useCd
...
c     SORT BY cov(point,vol)
         call isortem(1,nvol,covvol,1,temp,c,d,e,f,g,h)
